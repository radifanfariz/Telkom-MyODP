...
//        }
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = ProgressDialog.show(Login.this, null, "Harap Tunggu...", true, false);
                requestLogin();
            }
        });
...
//                                    Toast.makeText(Login.this, nik, Toast.LENGTH_SHORT).show();
                                    Toast.makeText(Login.this, "BERHASIL LOGIN", Toast.LENGTH_SHORT).show();
//                                    String nama = jsonRESULTS.getJSONObject("user").getString("nama");
                                    editor.putString("filter",nik);
                                    editor.apply();
                                    Intent intent = new Intent(Login.this, ScrollingActivity
                                            .class);
